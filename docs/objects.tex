...
in a refernce implementation of the NBDRA. We expect that this
...
apllication use cases have considerably contributed towards the design
...
numbers refering to the section that we use to describe the specific
interface categories in support of teh NBDRA (see
...
crosscutting interface requirements form Volume 3 \cite{nist-vol-3} of this series.
...
about the creatin can be found in Appendix \ref{s:cloudmesh-rest}.
...
404 & The requested resource couldnot be found. \\
...
\item[Virtual Cluster] A virtual cluster is a software cluster that
  ...
  agglomoration of compute resources. A virtual cluster allows user
...
Managing the document ther has provided us with the advantage that a
refernce implementation can be automatically derived from the
