...
\TODO{Subsection Scope: Discussion of high-level requirements of the
  interface approach for the System Orchestrator.}

\subsubsection{Application Providers Requirements}

\TODO{Subsection Scope: Discussion of high-level requirements of the
  interface approach for the Application Provider.}
...
\begin{figure}[!h]
\includegraphics[height=0.8\columnwidth]{images/dot/account.pdf}
\caption{Create Resource}\label{F:createresource}
\end{figure}

\begin{figure}[!h]
\centering
\includegraphics[width=0.8\textheight]{images/uml/account.pdf}
