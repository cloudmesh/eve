...
\begin{figure}[htb]
{\centering \digraph[scale=1.0]{MyGraph}{rankdir=LR; a->b; b->c}}
\caption{State diagram}\label{F:state1}
\end{figure}
...
\paragraph{Usecase: Create a resource}


\begin{figure}[htb]
{\centering \digraph[scale=1.0]{CreateAccountResource}{rankdir=LR; 
a->b [label="hallo"]
b->c [label="hello"]
}}
\caption{Create Resource}\label{F:create resource}
\end{figure}


statediagram
actions on the state diagram
