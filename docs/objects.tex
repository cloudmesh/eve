...
One of the elementary important features for Bid Data is the creation
of a Big Data Analysis Cluster. Instead of focussing only on the
deployment of a physical cluster the creation of a virtual cluster is
of advantage. A virtual cluster combines resources that generally ar
used to serve the Big Data Application and can constitute a variety of
data analysis nodes that together build the virtual cluster. 

Such a cluster can be hosted on clouds, containers, physical hardware
or a mix thereof. 
...
\codeFromJson{json}{virtual_compute_node.json}{Virtual
  compute node}{o:virtual-compute-node}
...
\codeFromJson{json}{virtual_machine.json}{Virtual machine}{o:virtual-machine}
