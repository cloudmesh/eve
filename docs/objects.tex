...
\ifdraft
  \documentclass[9pt,twocolumn]{styles/osajnl} 
\else
  \documentclass[10pt]{styles/osajnl} 
...
\ifdraft
  \includegraphics[width=\linewidth]{images/vol8-diagrams}
\else
...
\subsubsubsection{Big Data Provider Framework Interface Requirements}
...
\subsubsubsection{Infrastructures Interface Requirements}
...
\subsubsubsection{Platforms Interface Requirements}
...
\subsubsubsection{Processing Interface Requirements}
...
\subsubsubsection{Crosscutting Interface Requirements}
...
or others \TODO{\cite{??}}, we need a very simple way of distinguishing
...
\TODO{The motivations for a File Alias should be clearly described.}
