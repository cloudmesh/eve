...
\codeFromFile{json}{../samples/profile.json}{User profile}{s:profile}

\subsection{user}

\codeFromFile{json}{../samples/user.json}{user}{s:user}
...
\codeFromFile{json}{../samples/var.json}{var}{s:var}

\subsection{Default}

\codeFromFile{json}{../samples/default.json}{default}{s:default}
...
\codeFromFile{json}{../samples/file.json}{file}{s:file}

\subsection{File Alias}

A file could have one alias or even multiple ones.

\codeFromFile{json}{../samples/file_alias.json}{file alias}{s:file-alias}
...
\codeFromFile{json}{../samples/replica.json}{replica}{s:replica}
...
\codeFromFile{json}{../samples/virtual_directory.json}{virtual
...
\codeFromFile{json}{../samples/database.json}{database}{s:database}
...
\codeFromFile{json}{../samples/openstack_flavor.json}{openstack flavor}{s:openstack-flavor}

\subsubsection{Openstack Image}

\codeFromFile{json}{../samples/openstack_image.json}{openstack
  image}{s:openstack-image}

\subsubsection{Openstack Vm}

\codeFromFile{json}{../samples/openstack_vm.json}{openstack
  vm}{s:openstack-vm}
...
\codeFromFile{json}{../samples/azure-size.json}{azure-size}{s:azure-size}


\subsubsection{Azure Image}

\codeFromFile{json}{../samples/azure-image.json}{azure-image}{s:azure-image}

\subsubsection{Azure Vm}

An Azure virtual machine
\codeFromFile{json}{../samples/azure-vm.json}{azure-vm}{s:azure-vm}
...
\codeFromFile{json}{../samples/batchjob.json}{batchjob}{s:batchjob}
...
\codeFromFile{json}{../samples/cluster.json}{cluster}{s:cluster}
\
...
\codeFromFile{json}{../samples/compute_resource.json}{compute resource}{s:compute-resource}
...
\codeFromFile{json}{../samples/computer.json}{computer}{s:computer}
...
\codeFromFile{json}{../samples/node-new.json}{node-new}{s:node-new}
...
\codeFromFile{json}{../samples/virtual_cluster.json}{virtual
  cluster}{s:virtual-cluster}

\subsection{Virtual Compute node}

\codeFromFile{json}{../samples/virtual_compute_node.json}{virtual
...
\codeFromFile{json}{../samples/virtual_machine.json}{virtual machine}{s:virtual-machine}

\subsection{Mesos}

\codeFromFile{json}{../samples/mesos.json}{mesos}{s:mesos}
...
\codeFromFile{json}{../samples/container.json}{container}{s:container}

\subsection{Kubernetes}

\codeFromFile{json}{../samples/kubernetes.json}{kubernetes}{s:kubernetes}
...
\codeFromFile{json}{../samples/deployment.json}{deployment}{s:deployment}
...
\codeFromFile{json}{../samples/hadoop.json}{hadoop}{s:hadoop}
...
\codeFromFile{json}{../samples/mapreduce.json}{mapreduce}{s:mapreduce}
...
\codeFromFile{json}{../samples/key.json}{key}{s:key}
...
\codeFromFile{json}{../samples/microservice.json}{microservice}{s:microservice}
...
\codeFromFile{json}{../samples/reservation.json}{reservation}{s:reservation}
...
\codeFromFile{json}{../samples/profile.json}{profile}{s:profile}
