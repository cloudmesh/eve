...
%\author{Gregor von Laszewski,Fugang Wang, Wo L. Chang}

\date{Draft v0.0.1, \today} 
\newtoggle{fancyjson}
%\toggletrue{fancyjson}
\togglefalse{fancyjson}
...
\includegraphics[width=1.1\textwidth]{images/vol8-nbdra.pdf}
...
\JSONINPUT{json}{profile.json}{Example object specification}{sample:profile}
...
\begin{figure*}[h]\centering
\includegraphics[width=1.1\textwidth]{images/interfaces.pdf}
...
\JSONINPUT{json}{profile.json}{Profile}{o:profile}
...
\JSONINPUT{json}{user.json}{Organization}{o:user}
...
\JSONINPUT{json}{organization.json}{User}{o:organization}
...
\JSONINPUT{json}{group.json}{Group}{o:group}
...
\JSONINPUT{json}{role.json}{Role}{o:role}
...
\JSONINPUT{json}{timestamp.json}{Timestamp}{o:timestamp}
...
\JSONINPUT{json}{var.json}{Var}{o:var}
...
\JSONINPUT{json}{default.json}{Default}{o:default}
...
\JSONINPUT{json}{file.json}{File}{o:file}
...
\JSONINPUT{json}{file_alias.json}{File alias}{o:file-alias}
...
\JSONINPUT{json}{replica.json}{Replica}{o:replica}
...
\JSONINPUT{json}{virtual_directory.json}{Virtual directory}{o:virtual-directory}
...
\JSONINPUT{json}{database.json}{Database}{o:database}
...
\JSONINPUT{json}{stream.json}{Stream}{o:stream}
...
\JSONINPUT{json}{filter.json}{Filter}{o:filter}
...
\JSONINPUT{json}{virtual_cluster.json}{Virtual cluster}{o:virtual-cluster}

\JSONINPUT{json}{virtual_cluster_provider.type}{Virtual cluster provider}{o:virtual-cluster-provider}

% \JSONINPUT{json}{cluster.json}{Cluster}{o:cluster}
...
\JSONINPUT{json}{virtual_machine.json}{Compute node of a virtual cluster}{o:virtual-machine}
...
\JSONINPUT{json}{flavor.json}{Flavor}{o:flavor}


%
% BEGIN OLD
%
% \JSONINPUT{json}{virtual_compute_node.json}{Compute node}{o:virtual-compute-node}
% \JSONINPUT{json}{compute_resource.json}{Compute resource}{o:compute-resource}
% \JSONINPUT{json}{computer.json}{Computer}{o:computer}
%
% END OLD
%
...
\JSONINPUT{json}{nic.json}{Network interface card}{o:nic}
...
\JSONINPUT{json}{sshkey.json}{Key}{o:key}
...
\JSONINPUT{json}{security_group.json}{Security Groups}{o:secgroup}
...
%\JSONINPUT{json}{cluster_new.json}{Cluster}{o:cluster-new}
%
...
% \JSONINPUT{json}{node.json}{Node}{o:node}

% \JSONINPUT{json}{node-new.json}{Node}{o:node}
...
\JSONINPUT{json}{libcloud_flavor.json}{Libcloud flavor}{o:libcloud-flavor}
...
\JSONINPUT{json}{libcloud_image.json}{Libcloud image}{o:libcloud-image}
...
\JSONINPUT{json}{libcloud_vm.json}{LibCloud VM}{o:libcloud-vm}
...
\JSONINPUT{json}{libcloudNode.json}{LibCloud Node}{o:libcloud-node}
...
\JSONINPUT{json}{openstack_flavor.json}{Openstack flavor}{o:openstack-flavor}
...
\JSONINPUT{json}{openstack_image.json}{Openstack image}{o:openstack-image}
...
\JSONINPUT{json}{openstack_vm.json}{Openstack vm}{o:openstack-vm}
...
\JSONINPUT{json}{azure-size.json}{Azure-size}{o:azure-size}
...
\JSONINPUT{json}{azure-image.json}{Azure-image}{o:azure-image}
...
\JSONINPUT{json}{azure-vm.json}{Azure-vm}{o:azure-vm}
...
\JSONINPUT{json}{batchjob.json}{Batchjob}{o:batchjob}
...
\JSONINPUT{json}{reservation.json}{Reservation}{o:reservation}
...
\JSONINPUT{json}{mesos.json}{Mesos}{o:mesos}
\end{comment}
...
\JSONINPUT{json}{container.json}{Container}{o:container}
...
\JSONINPUT{json}{kubernetes.json}{Kubernetes}{o:kubernetes}
\end{comment}
...
\JSONINPUT{json}{deployment.json}{Deployment}{o:deployment}
...
\JSONINPUT{json}{mapreduce.json}{Mapreduce}{o:mapreduce}
...
\JSONINPUT{json}{mapreduce_function_prototype.json}{Mapreduce function}{o:mr.f.prototype}
...
\JSONINPUT{json}{mapreduce_function_noop.json}{Mapreduce noop}{o:mr.f.noop}
...
\JSONINPUT{json}{hadoop.json}{Hadoop}{o:hadoop}
...
\JSONINPUT{json}{microservice.json}{Microservice}{o:microservice}
...
\JSONINPUT{json}{accounting.json}{Accounting}{o:accounting}

\JSONINPUT{json}{account.json}{Account}{o:account}
...
\JSONINPUT{python}{../settings.settings.py}{Schema}{l:schema}
