...
and looks for the specific object, introduced earlier, as follows:
...
When using the objects, it is assumed one can implement the typical CRUD
...
In the reference implementation in this document these methods are provided
automatically.
