...
\codeFromFile{json}{../cloudmesh/specification/profile.json}{User profile}{s:profile}

\subsection{user}

\codeFromFile{json}{../cloudmesh/specification/user.json}{user}{s:user}
...
\codeFromFile{json}{../cloudmesh/specification/var.json}{var}{s:var}

\subsection{Default}

\codeFromFile{json}{../cloudmesh/specification/default.json}{default}{s:default}
...
\codeFromFile{json}{../cloudmesh/specification/file.json}{file}{s:file}

\subsection{File Alias}

A file could have one alias or even multiple ones.

\codeFromFile{json}{../cloudmesh/specification/file_alias.json}{file alias}{s:file-alias}
...
\codeFromFile{json}{../cloudmesh/specification/replica.json}{replica}{s:replica}
...
\codeFromFile{json}{../cloudmesh/specification/virtual_directory.json}{virtual
...
\codeFromFile{json}{../cloudmesh/specification/database.json}{database}{s:database}
...
\codeFromFile{json}{../cloudmesh/specification/openstack_flavor.json}{openstack flavor}{s:openstack-flavor}

\subsubsection{Openstack Image}

\codeFromFile{json}{../cloudmesh/specification/openstack_image.json}{openstack
  image}{s:openstack-image}

\subsubsection{Openstack Vm}

\codeFromFile{json}{../cloudmesh/specification/openstack_vm.json}{openstack
  vm}{s:openstack-vm}
...
\codeFromFile{json}{../cloudmesh/specification/azure-size.json}{azure-size}{s:azure-size}


\subsubsection{Azure Image}

\codeFromFile{json}{../cloudmesh/specification/azure-image.json}{azure-image}{s:azure-image}

\subsubsection{Azure Vm}

An Azure virtual machine
\codeFromFile{json}{../cloudmesh/specification/azure-vm.json}{azure-vm}{s:azure-vm}
...
\codeFromFile{json}{../cloudmesh/specification/batchjob.json}{batchjob}{s:batchjob}
...
\codeFromFile{json}{../cloudmesh/specification/cluster.json}{cluster}{s:cluster}
\
...
\codeFromFile{json}{../cloudmesh/specification/compute_resource.json}{compute resource}{s:compute-resource}
...
\codeFromFile{json}{../cloudmesh/specification/computer.json}{computer}{s:computer}
...
\codeFromFile{json}{../cloudmesh/specification/node-new.json}{node-new}{s:node-new}
...
\codeFromFile{json}{../cloudmesh/specification/virtual_cluster.json}{virtual
  cluster}{s:virtual-cluster}

\subsection{Virtual Compute node}

\codeFromFile{json}{../cloudmesh/specification/virtual_compute_node.json}{virtual
...
\codeFromFile{json}{../cloudmesh/specification/virtual_machine.json}{virtual machine}{s:virtual-machine}

\subsection{Mesos}

\codeFromFile{json}{../cloudmesh/specification/mesos.json}{mesos}{s:mesos}
...
\codeFromFile{json}{../cloudmesh/specification/container.json}{container}{s:container}

\subsection{Kubernetes}

\codeFromFile{json}{../cloudmesh/specification/kubernetes.json}{kubernetes}{s:kubernetes}
...
\codeFromFile{json}{../cloudmesh/specification/deployment.json}{deployment}{s:deployment}
...
\codeFromFile{json}{../cloudmesh/specification/hadoop.json}{hadoop}{s:hadoop}
...
\codeFromFile{json}{../cloudmesh/specification/mapreduce.json}{mapreduce}{s:mapreduce}
...
\codeFromFile{json}{../cloudmesh/specification/key.json}{key}{s:key}
...
\codeFromFile{json}{../cloudmesh/specification/microservice.json}{microservice}{s:microservice}
...
\codeFromFile{json}{../cloudmesh/specification/reservation.json}{reservation}{s:reservation}
...
\codeFromFile{json}{../cloudmesh/specification/profile.json}{profile}{s:profile}
